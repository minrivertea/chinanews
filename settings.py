# Django settings for chinanews project.
...
ADMINS = (
    ('Chris West', 'chris@wheninchina.com'),
)
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'chinanews.context_processors.common',
)
...
DEFAULT_FROM_EMAIL = "mail@chinanews.com"
