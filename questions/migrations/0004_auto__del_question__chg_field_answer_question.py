...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('questions_answer', 'question_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['list.CommonInfo']))
    ...
    def backwards(self, orm):
        ...
        db.create_table('questions_question', (
            ...
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 12, 19, 50, 10, 525100))),
    ...
    models = {
        ...
        'questions.answer': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 7, 9, 34, 57, 583646)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['list.CommonInfo']"}),
